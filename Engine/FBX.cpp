...
HRESULT FBX::LoadSkinned(std::string fileName)
{
	//マネージャを生成
...
void FBX::DrawSkinned(Transform& transform, int frame)
{
	Direct3D::SetBlend(BLEND_INVALID);
	Direct3D::SetShader(SHADER_3D);
...
void FBX::RayCastSkinned(RayCastData& rayData, Transform& transform)
{
	rayData.dist = 999.0f;
