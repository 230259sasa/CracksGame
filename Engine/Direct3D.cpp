...
bool Direct3D::Intersect(XMFLOAT4& start, XMFLOAT4& direction, XMFLOAT3& v0, XMFLOAT3& v1, XMFLOAT3& v2, float* distance)
{
	// 微小な定数([M?ller97] での値)
	...
	XMVECTOR alpha = XMVector3Cross(XMLoadFloat4(&direction), edge2);
	...
	float v = XMVector3Dot(XMLoadFloat4(&direction), beta).m128_f32[0] * invDet;
	if (v < 0.0f || u + v > 1.0f)
	{
		return false;
	}
